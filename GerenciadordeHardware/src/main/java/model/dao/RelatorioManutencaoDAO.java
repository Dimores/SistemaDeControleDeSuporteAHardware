...
public class RelatorioManutencaoDAO implements IDao {
    ...
    public void save(Object obj) {
        ...
        sql = " INSERT INTO "
                + " relatorio_manutencao(idRelatorio, dataRelatorio, descricao, equipamentos, cliente_id, tecnico_id) "
                + " VALUES(?,?,?,?,?,?) ";
        try {
            ...
            statement.setDate(2, dataRelatorioSql);

            statement.setString(3, relatorioManutencao.getDescricao());
            statement.setString(4, relatorioManutencao.getEquipamentos());

            // Preencher com o ID do cliente e do técnico
            statement.setString(5, relatorioManutencao.getCliente().getIdCliente());
            statement.setString(6, relatorioManutencao.getTecnico().getId());
    ...
    public void update(Object obj) {
        ...
        sql = " UPDATE relatorio_manutencao "
                + " SET idRelatorio = ?, dataRelatorio = ?, descricao = ?, equipamentos = ?, cliente_id = ?, tecnico_id = ? "
                + " WHERE id = ?";
        try {
            connection = Persistencia.getConnection();
            statement = connection.prepareStatement(sql);
            ...
            statement.setString(7, relatorioManutencao.getIdRelatorio());
