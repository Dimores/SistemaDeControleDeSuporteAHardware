...
public class dlgSelecaoInstalacaoRede extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgSelecaoInstalacaoRede.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgSelecaoInstalacaoRede dialog = new dlgSelecaoInstalacaoRede(new javax.swing.JDialog(), true);
