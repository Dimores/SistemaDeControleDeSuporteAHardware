...
public class dlgSelecaoCliente extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgSelecaoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgSelecaoCliente dialog = new dlgSelecaoCliente(new javax.swing.JDialog(), true);
