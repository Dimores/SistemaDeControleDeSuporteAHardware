...
public class dlgSelecaoManutencaoPreventiva extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgSelecaoManutencaoPreventiva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgSelecaoManutencaoPreventiva dialog = new dlgSelecaoManutencaoPreventiva(new javax.swing.JDialog(), true);
