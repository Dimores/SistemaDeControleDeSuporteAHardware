...
public class JCheckBoxCustom extends JCheckBox {
    ...
    public JCheckBoxCustom() {
        ...
        setUI(new BasicCheckBoxUI() {
            protected void paintFocus(Graphics g, Rectangle textRect, Rectangle iconRect, Rectangle viewRect, Rectangle checkRect) {
                // Não faz nada para evitar o desenho da marca de seleção
            }
        });
    }
